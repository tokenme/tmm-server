...
type CreateMultiPushRequest struct {
	xinge.BaseRequest
...
func (this CreateMultiPushRequest) HttpMethod() xinge.HttpMethod {
	return xinge.GET
}

func (this CreateMultiPushRequest) Method() string {
	return "create_multipush"
}

func (this CreateMultiPushRequest) Class() string {
	return "push"
}
