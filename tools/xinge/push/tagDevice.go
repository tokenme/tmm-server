...
type TagDeviceRequest struct {
	xinge.BaseRequest
	TagList      []string `json:"tags_list"`
	TagsOp       string   `json:"tags_op"`      // 取值为 AND 或 OR
...
func (this TagDeviceRequest) HttpMethod() xinge.HttpMethod {
	return xinge.GET
}

func (this TagDeviceRequest) Method() string {
	return "tags_device"
}

func (this TagDeviceRequest) Class() string {
	return "push"
}
