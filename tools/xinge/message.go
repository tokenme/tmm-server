...
type IosMessage struct {
	...
	UserInfo map[string]interface{} `json:"user_info,omitempty"` //参考android的自定义属性
}
...
type ApsAttr struct {
	...
	AcceptTime       []AcceptTime `json:"accept_time,omitempty"`
...
func (this IosMessage) String() string {
...
func (this AndroidMessage) String() string {
	res, _ := json.Marshal(this)
	return string(res)
}
